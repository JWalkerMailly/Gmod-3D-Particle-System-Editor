	...
	panel:AddItem(category);
		...
		category:SetContents(container);
			...
			particleProps:Dock(TOP);
				...
				local mathLookup = GLOBALS_3D_PARTICLE_PARSER.MathFunctionsConversionTable;
				...
				self:AddParticlePropertyRow(worker, particleProps, label, "RotationFunction",     "Rotation",  "Function",              "Combo",   {},                              mathLookup, "Sine", useConfig);
				...
				self:AddParticlePropertyRow(worker, particleProps, label, "ColorFunction",        "Color",     "Function",              "Combo",   {},                              mathLookup, "Sine", useConfig);
				...
				self:AddParticlePropertyRow(worker, particleProps, label, "AlphaFunction",        "Alpha",     "Function",              "Combo",   {},                              mathLookup, "Sine", useConfig);
				...
				self:AddParticlePropertyRow(worker, particleProps, label, "ScaleFunction",        "Scale",     "Function",              "Combo",   {},                              mathLookup, "Sine", useConfig);
				...
				self:AddParticlePropertyRow(worker, particleProps, label, "AxisScaleFunction",    "Axis",      "Function",              "Combo",   {},                              mathLookup, "Sine", useConfig);
...
function GLOBALS_3D_PARTICLE_EDITOR:Save(worker, name, path, silent)
	...
	local configFile = string.Replace(path .. "/" .. name .. ".lua.txt", "data/", "");
